...
sealed class ScriptExecutionOrder : Attribute
{
    public readonly int ExecutionOrder = 0;
    public ScriptExecutionOrder(int executionOrder)
    {
    ...
    {
        var type = typeof(ScriptExecutionOrder);
        var assembly = type.Assembly;
        var types = assembly.GetTypes();
        var scripts = new Dictionary<MonoScript, ScriptExecutionOrder>();
        ...
        foreach (var item in types)
        {
            ...
            var attribute = attributes[0] as ScriptExecutionOrder;
