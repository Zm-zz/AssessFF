    ...
    public class Array2DDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            using (new NewIndentLevel(0))
            {
                ...
                float rowHeight = EditorGUI.GetPropertyHeight(property.propertyType, GUIContent.none);
                Rect rect = new()
                {
                    x = position.x,
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing //foldout
                ...
                //table size
                + rowAmount.intValue * (EditorGUI.GetPropertyHeight(property.propertyType, GUIContent.none)
