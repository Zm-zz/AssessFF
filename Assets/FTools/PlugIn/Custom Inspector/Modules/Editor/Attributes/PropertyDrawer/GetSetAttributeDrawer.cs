...
namespace CustomInspector.Editor
{
    ...
    public class GetSetAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                height = EditorGUI.GetPropertyHeight(PropertyConversions.ToPropertyType(getter.ReturnType), label),
            };
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            //Draw
            return EditorGUI.GetPropertyHeight(PropertyConversions.ToPropertyType(getter.ReturnType), label) + EditorGUIUtility.standardVerticalSpacing
